...
const focus_icon = reactive([
  {
    ...
    qr: "../../../src/assets/img/focus/qr_weibo.png",
    info: "关注官方微博",
  },
  {
    name: "weixin",
    path: "../../../src/assets/img/focus/weixin.svg",
    qr: "../../../src/assets/img/focus/qr_weixin.png",
    info: "关注官方微信公众号",
  },
  {
    name: "bilibili",
    path: "../../../src/assets/img/focus/bilibili.png",
    qr: "../../../src/assets/img/focus/qr_bilibili.png",
